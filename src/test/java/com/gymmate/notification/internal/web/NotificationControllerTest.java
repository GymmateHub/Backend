...
class NotificationControllerTest {
    ...
    @Mock
    private GymAccessVerifier gymAccessVerifier;
    ...
    class GymAccessTests {
        ...
        void shouldDenyAccessWhenGymBelongsToDifferentOrg() throws Exception {
            ...
            doThrow(new DomainException("ACCESS_DENIED", "You do not have access to this gym"))
                    .when(gymAccessVerifier).verifyGymBelongsToOrganisation(eq(gymId), any());
        ...
        void shouldReturn404WhenGymNotFound() throws Exception {
            ...
            doThrow(new ResourceNotFoundException("Gym", gymId.toString()))
                    .when(gymAccessVerifier).verifyGymBelongsToOrganisation(eq(gymId), any());
