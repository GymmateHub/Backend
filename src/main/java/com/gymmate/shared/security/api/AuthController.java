...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> registerUser(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(UserResponse.fromEntity(user), "User registered successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<UserResponse>> registerMember(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(UserResponse.fromEntity(user), "Member registered successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<GymSwitchResponse>> switchGym(
        ...
        if (!organisationId.equals(gym.getOrganisationId())) {
            throw new DomainException("GYM_ACCESS_DENIED", "The selected gym does not belong to your organisation");
        }
