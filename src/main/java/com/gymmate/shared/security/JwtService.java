...
public class JwtService {
  ...
  public UUID extractUserId(String token) {
    ...
    if (userId == null) {
      // Fallback to subject if userId claim doesn't exist (for tokens generated by JwtTokenProvider)
  ...
  public UUID extractGymId(String token) {
    ...
    if (gymId == null) {
      // Fallback to tenantId if gymId claim doesn't exist (for tokens generated by JwtTokenProvider)
