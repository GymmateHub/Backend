...
CREATE TABLE IF NOT EXISTS gyms (
    ...
    subscription_expires_at TIMESTAMP,
    max_members INTEGER DEFAULT 200,
    provider_connect_account_id VARCHAR(255),
    provider_charges_enabled BOOLEAN DEFAULT FALSE,
    provider_payouts_enabled BOOLEAN DEFAULT FALSE,
    provider_details_submitted BOOLEAN DEFAULT FALSE,
    provider_onboarding_completed_at TIMESTAMP,
    features_enabled JSONB DEFAULT '[]',
    onboarding_completed BOOLEAN DEFAULT FALSE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
