-- ============================================================================
-- V13: Recreate Leads table
-- V10__Leads.sql was never applied to this database: the schema history is
-- already at version 12 (out-of-order migrations are disabled), so Flyway
-- skips V10 forever, and Hibernate's ddl-auto update cannot create the table
-- either ("both default and identity specified for column id"). Re-issuing
-- the DDL above the current version fixes the missing relation.
-- Identical to V10; IF NOT EXISTS keeps it a no-op where V10 did apply.
-- ============================================================================
